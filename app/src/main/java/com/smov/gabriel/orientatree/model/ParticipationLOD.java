...
public class ParticipationLOD implements Comparator<ParticipationLOD>, Serializable {
    ...
    public ParticipationLOD() {

    }

    public ParticipationLOD(String participant) {
    ...
    @Override
    public int compare(ParticipationLOD o1, ParticipationLOD o2) {
